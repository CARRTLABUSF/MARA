...
def runOPE(wait=True):
    print "Starting OPE"
    ope_process = subprocess.Popen("./ope-new", shell=True, cwd="/home/andoni/ROS/ws_carrt_kyle-master/src/mara/OPE-Release/", preexec_fn=os.setsid)
...
def loadOPEResults():
    ...
    ope_results = open("/home/andoni/ROS/ws_carrt_kyle-master/src/mara/OPE-Release/OPE-Results.txt")
...
def showOPEResults():
    subprocess.Popen("ristretto output.png", shell=True,
                     cwd="/home/andoni/ROS/ws_carrt_kyle-master/src/mara/OPE-Release/")
